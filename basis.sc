...
s.waitForBoot {
	...
	~dirt.start(57120, [0, 0, 0, 0, 0, 0, 0, 0]); // start listening on port 57120, create 8 orbits, each sending audio to channel 0. You can direct sounds to the orbits from tidal e.g. by: `# orbit "0 1 1"
}
)
